//==--- ripple/viz/printable/printable_traits.hpp ---------- -*- c++ -*- ---==//
//            
//                                Ripple
// 
...
#ifndef RIPPLE_VIZ_PRINTABLE_PRINTABLE_TRAITS_HPP
#define RIPPLE_VIZ_PRINTABLE_PRINTABLE_TRAITS_HPP
...
template <typename Impl> class Printable;
...
#endif // RIPPLE_VIZ_PRINTABLE_PRINTABLE_TRAITS_HPP
