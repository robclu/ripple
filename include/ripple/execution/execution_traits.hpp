...
/**
 * Defines the types of operations for memory transfer operations.
 */
enum class TransferKind : uint8_t {
  synchronous  = 0, //!< Synchrnous with respect to compute.
  asynchronous = 1  //!< Asynchronous with respect to compute.
};
