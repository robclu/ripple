/**=--- ripple/execution/thread_index_impl_.hpp ------------ -*- C++ -*- ---==**
 *
 *                                  Ripple
 *
...
struct Dim3 {
   ...
   */
  ripple_host_device constexpr auto set(size_t value) noexcept -> void {
    x = value;
    y = value;
    z = value;
  }
   ...
   */
  ripple_host_device constexpr auto reset() noexcept -> void {
    set(0ul);
  }
};
