//==--- ripple/fvm/limiting/superbee_limiter.hpp ----------- -*- C++ -*- ---==//
//            
//                                Ripple
// 
...
/// \brief This file defines an implementation of a SUPERBEE limiter.
//
//==------------------------------------------------------------------------==//

#ifndef RIPPLE_LIMITER_SUPERBEE_LIMITER_HPP
#define RIPPLE_LIMITER_SUPERBEE_LIMITER_HPP
...
/// Implemenation of the limtier interface which performs SUPEREE limiting.
class SuperbeeLimiter : public Limiter<SuperbeeLimiter> {
  /// Defines the type of the base limiter.
  using base_limiter_t = Limiter<SuperbeeLimiter>;
...
#endif // RIPPLE_LIMITER_SUPERBEE_LIMITER_HPP