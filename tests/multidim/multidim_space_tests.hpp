//==--- ripple/tests/multidim/multidim_space_tests.cpp ----- -*- C++ -*- ---==//
//            
//                                Ripple
// 
...
//==------------------------------------------------------------------------==//
//
/// \file  multidim_space_tests.hpp
/// \brief This file contains tests for multidimensional space information.
//
//==------------------------------------------------------------------------==//

#ifndef RIPPLE_TESTS_MULTIDIM_MULTIDIM_SPACE_TESTS_HPP
#define RIPPLE_TESTS_MULTIDIM_MULTIDIM_SPACE_TESTS_HPP

#include <ripple/multidim/multidim_space.hpp>
#include <ripple/utility/dim.hpp>
#include <gtest/gtest.h>

TEST(multidim_multidim_space, size_and_step_1d) {
  using space_t = ripple::MultidimSpace<1>;
...
TEST(multidim_multidim_space, size_and_step_2d) {
  using space_t = ripple::MultidimSpace<2>;
...
TEST(multidim_multidim_space, size_and_step_3d) {
  using space_t = ripple::MultidimSpace<3>;
...
#endif // RIPPLE_TESTS_MULTIDIM_MULTIDIM_SPACE_TESTS_HPP
